...
const Carousl_Products = ({ images }) => {
    ...
    return (
        ...
        >
            ...
            <button
                onClick={prevSlide}
                className="absolute cursor-pointer duration-200 top-1/2 left-3 transform -translate-y-1/2  bg-opacity-50 text-white w-8 h-8 flex items-center justify-center hover:bg-opacity-80"
            >
            ...
            <button
                onClick={nextSlide}
                className="absolute cursor-pointer duration-200 top-1/2 right-3 transform -translate-y-1/2 bg-opacity-50 text-white w-8 h-8 flex items-center justify-center hover:bg-opacity-80"
            >
...
export default Carousl_Products;
