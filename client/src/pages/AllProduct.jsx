...
import ProductCard from "../components/ProductCard"; // make sure you import this
...
export default function AllProducts() {
  ...
  return (
    <div className="flex relative p-5">
      ...
      {/* Sidebar */}
      <div
        className={`absolute z-30 top-0 left-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${
